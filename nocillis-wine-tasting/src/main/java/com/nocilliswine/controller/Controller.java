...
public class Controller {
	...
	public ResponseEntity<InputStreamResource> generateBuyingList(@RequestBody MultipartFile file) throws Exception {
		if (file == null) {
		...
		File outputFile = wineBuyingService.readAndGetBuyingList(file);
